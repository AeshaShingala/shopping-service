    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div class="col-lg-3 col-6 text-right">
                <a href="#" class="btn border" data-toggle="dropdown">Login <i class="fa fa-angle-down float-right mt-1"></i>
                    <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-30 m-0">
                        ...
                        <a href="/login/super-admin" class="dropdown-item">SuperAdmin</a>
                    </div>
                </a>
                <a href="#" class="btn border" data-toggle="dropdown">Register <i class="fa fa-angle-down float-right mt-1"></i>
                    <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-30 m-0">
                        ...
                        <a href="/signup/super-admin" class="dropdown-item">SuperAdmin</a>
                    </div>
                </a>
            </div>
        </div>

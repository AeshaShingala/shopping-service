            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 1;">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        ...
                        <a href="/buyer/products/${category.categoryId}/${user.userId}" class="nav-item nav-link">${category.name}</a>
                    </c:forEach>
                    </div>
                </nav>
            </div>
                ...
                <div class="border-bottom mb-4 pb-4">
                    ...
                    <form>
                        ...
                        <c:forEach items="${listOfColours}" var="colour">
                            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                                <input type="checkbox" class="custom-control-input" id="colour">
                                <label class="custom-control-label" for="colour">${colour.name}</label>
                            </div>
                    </c:forEach>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-between bg-light border">
                                ...
                                <a href="/buyer/product/wishlist/${product.productId}/${user.userId}" class="btn btn-sm text-dark p-0"><i class="fas fa-heart text-primary mr-1"></i>Wishlist</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>

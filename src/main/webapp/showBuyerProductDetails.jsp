    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            ...
            <div class="d-inline-flex">
                <p class="m-0"><a href="/buyer/home">Home</a></p>
                <p class="m-0 px-2">-</p>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="my-form" action="/buyer/product/cart" method="post">
                            ...
                            <div class="container-fluid py-5">
                                <div class="row px-xl-5">
                                    <div class="col-lg-5 pb-5">
                                        <img class="img-fluid w-100" src="/productImages/${product.image}" style="width: 200px; height: 400px">
                                    </div>
                                    <div class="col-lg-7 pb-5">
                                        ...
                                        <div class="d-flex mb-3">
                                            <p class="text-dark font-weight-medium mb-0 mr-3">Sizes:</p>
                                                ...
                                                <c:forEach items="${listOfSizes}" var="sizes">
                                                <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" class="custom-control-input" id="${sizes}" name="sizes" path="sizes" value="${sizes}">
                                                        <label class="custom-control-label" for="${sizes}" >${sizes}</label>
                                                    </div>
                                                </c:forEach>
                                        ...
                                        <div class="d-flex mb-4">
                                            <p class="text-dark font-weight-medium mb-0 mr-3">Colours:</p>
                                                ...
                                                <c:forEach items="${listOfColours}" var="colour">
                                                <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" class="custom-control-input" id="${colour.name}" name="colour" path="colour" value="${colour.name}">
                                                        <label class="custom-control-label" for="${colour.name}">${colour.name}</label> 
                                                    </div>
                                                </c:forEach>
